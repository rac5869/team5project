            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="location.locId.label" default="Loc Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: locationInstance, field: "locId")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="location.street2.label" default="Street2" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: locationInstance, field: "street2")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="location.street1.label" default="Street1" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: locationInstance, field: "street1")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="location.zipCode.label" default="Zip Code" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: locationInstance, field: "zipCode")}</td>
